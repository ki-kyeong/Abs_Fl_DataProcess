...
if Data.size.freq == 1
    ...
    switch kind
        case 'abs'
            result = imagesc(ax, Data.t(StartTimeIdx:EndTimeIdx)*1e-3, Data.det.UV.wm.mean.Q, Data.abs.tt(StartTimeIdx:EndTimeIdx,:).');
        ...
        case 'fl1'
            if Data.beamaxis =='xy'
                ...
                result = imagesc(ax, Data.t(StartTimeIdx:EndTimeIdx)*1e-3, Data.det.UV.wm.mean.P, Data.fl.tt(StartTimeIdx:EndTimeIdx,:).'); hold on;
                % hold on;
            ...
            elseif Data.beamaxis == 'z'
                result = imagesc(ax, Data.t(StartTimeIdx:EndTimeIdx)*1e-3, Data.det.UV.wm.mean.Q, Data.fl.tt(StartTimeIdx:EndTimeIdx,:).'); hold on;
                ylabel("detuning from Q_{12}(1) (MHz)",'fontsize',16);
            end
        case 'fl2'
