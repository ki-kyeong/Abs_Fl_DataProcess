function FitResults = LF_MgF_v2(data, c1 )
...
ft = fittype('a1*(2*(22^2/4)/((x-b1)^2+(22^2/4)*(1+c1))+4*(22^2/4)/((x-b1-14)^2+(22^2/4)*(1+c1))+6*(22^2/4)/((x-b1-35.3)^2+(22^2/4)*(1+c1))+4*(22^2/4)/((x-b1-66.7)^2+(22^2/4)*(1+c1))+8*(22^2/4)/((x-b1-113)^2+(22^2/4)*(1+c1))+6*(22^2/4)/((x-b1-118.1)^2+(22^2/4)*(1+c1))+8*(22^2/4)/((x-b1-972.8)^2+(22^2/4)*(1+c1))+10*(22^2/4)/((x-b1-973.2)^2+(22^2/4)*(1+c1))+6*(22^2/4)/((x-b1-1043.6)^2+(22^2/4)*(1+c1))+8*(22^2/4)/((x-b1-1111.1)^2+(22^2/4)*(1+c1))+6*(22^2/4)/((x-b1-1145.8)^2+(22^2/4)*(1+c1))+4*(22^2/4)/((x-b1-1158.8)^2+(22^2/4)*(1+c1)))+d1',...
    'independent', 'x', 'dependent', 'y' );
    % ft = fittype('a1*(2*(21^2/4)/((x-b1)^2+(21^2/4)*(1+c1))+4*(21^2/4)/((x-b1-14)^2+(21^2/4)*(1+c1))+6*(21^2/4)/((x-b1-35.3)^2+(21^2/4)*(1+c1))+4*(21^2/4)/((x-b1-66.7)^2+(21^2/4)*(1+c1))+8*(21^2/4)/((x-b1-113)^2+(21^2/4)*(1+c1))+6*(21^2/4)/((x-b1-118.1)^2+(21^2/4)*(1+c1))+8*(21^2/4)/((x-b1-972.8)^2+(21^2/4)*(1+c1))+10*(21^2/4)/((x-b1-973.2)^2+(21^2/4)*(1+c1))+6*(21^2/4)/((x-b1-1043.6)^2+(21^2/4)*(1+c1))+8*(21^2/4)/((x-b1-1111.1)^2+(21^2/4)*(1+c1))+6*(21^2/4)/((x-b1-1145.8)^2+(21^2/4)*(1+c1))+4*(21^2/4)/((x-b1-1158.8)^2+(21^2/4)*(1+c1)))+d1',...
    % 'independent', 'x', 'dependent', 'y' );
opts = fitoptions( 'Method', 'NonlinearLeastSquares' );
opts.Display = 'Off';
opts.Lower = [0 -4000  0 0 ];
opts.StartPoint = [1e2  -3700 c1 0];
...
plotspec_v4(gca, data, 'fl1','UV'); hold on;
h = plot( fitresult ); hold off;
