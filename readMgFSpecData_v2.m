function results = readMgFSpecData_v2(name, freq_i, freq_f, freq_step,...
    iter, normmode, plotmode)

% update log 23/02/13
% v1에서 absorption beam을 sampling하여 background power fluctuation noise를 없애는 기능 추가
...
for j = 1 : dfsize
    ...
    for i = 1:iter
        ...
        TotalAbsBgDatas(:,i,j) = Data(:,6)-bg2;
